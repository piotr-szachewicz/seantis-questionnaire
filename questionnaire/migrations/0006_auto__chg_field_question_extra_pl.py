...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Question.extra_pl'
        db.alter_column(u'questionnaire_question', 'extra_pl', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))

    def backwards(self, orm):

        # Changing field 'Question.extra_pl'
        db.alter_column(u'questionnaire_question', 'extra_pl', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))
