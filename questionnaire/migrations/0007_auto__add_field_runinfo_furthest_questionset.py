...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RunInfo.furthest_questionset'
        db.add_column(u'questionnaire_runinfo', 'furthest_questionset',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='furthest', null=True, to=orm['questionnaire.QuestionSet']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RunInfo.furthest_questionset'
        db.delete_column(u'questionnaire_runinfo', 'furthest_questionset_id')
